        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden sm:flex sm:items-center">
              <Link to="/" className="text-gray-800 text-sm font-semibold hover:text-sky-500 mr-4"
              >

                Home
              </Link>

              <Link to="/AboutUs" className="text-gray-800 text-sm font-semibold hover:text-sky-500 mr-4">

                AboutUs
              </Link>
              <Link to="/ContactUs" className="text-gray-800 text-sm font-semibold hover:text-sky-500 mr-4">
                Contact Us
              </Link>
            ...
            <div className="hidden sm:flex sm:items-center">
              ...
              {userId ? (
                <>
                  <Link to="/profile" className="text-gray-800 text-sm font-semibold hover:text-sky-600 mr-4">
                    Profile
                  </Link>
                  <button onClick={logout} className="text-gray-800 text-sm font-semibold hover:text-sky-600 mr-4">
                    Logout
                  </button>
                </>
              ) : (
                <Link to="/login" className="text-gray-800 text-sm font-semibold hover:text-sky-600 mr-4">
                  Login
                </Link>
              )}

            </div>
            <div className="sm:hidden cursor-pointer" onClick={handleNavbarToggle}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className={`block sm:hidden bg-white border-t-2 py-2 ${isNavbarOpen ? 'block' : 'hidden'}`}>
            <div className="flex flex-col">

              <Link to="/" className="text-gray-800 text-sm font-semibold hover:text-sky-600 mb-1"
              >
                Home
              </Link>
              <Link to="/AboutUs" className="text-gray-800 text-sm font-semibold hover:text-sky-600 mb-1">

                AboutUs
              </Link>

              <Link to="/ContactUs" className="text-gray-800 text-sm font-semibold hover:text-sky-600 mr-4">
                Contact Us
              </Link>
